...
#[cfg(feature = "Win32_Security")]
windows_targets::link!("api-ms-win-appmodel-runtime-l1-1-7.dll" "system" fn GetProcessesUsingPackageDependency(packagedependencyid : windows_sys::core::PCWSTR, user : super::super::super::Security:: PSID, scopeissystem : super::super::super::Foundation:: BOOL, processidscount : *mut u32, processids : *mut *mut u32) -> windows_sys::core::HRESULT);
