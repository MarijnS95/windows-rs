...
windows_targets::link!("netapi32.dll" "system" fn NetIsServiceAccount2(servername : windows_sys::core::PCWSTR, accountname : windows_sys::core::PCWSTR, isservice : *mut super::super::Foundation:: BOOL, accounttype : *mut MSA_INFO_ACCOUNT_TYPE) -> super::super::Foundation:: NTSTATUS);
