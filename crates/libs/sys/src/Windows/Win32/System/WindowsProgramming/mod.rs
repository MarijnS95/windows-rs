...
pub type PWLDP_GETAPPLICATIONSETTINGBOOLEAN_API = Option<unsafe extern "system" fn(id: windows_sys::core::PCWSTR, setting: windows_sys::core::PCWSTR, result: *mut super::super::Foundation::BOOL) -> windows_sys::core::HRESULT>;
