...
impl Default for DXCoreAdapterEngineIndex {
    fn default() -> Self {
...
impl Default for DXCoreAdapterProcessSetQueryOutput {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DXCoreEngineNamePropertyOutput {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DXCoreEngineQueryInput {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DXCoreEngineQueryOutput {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DXCoreFrequencyQueryOutput {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DXCoreMemoryUsage {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DXCoreProcessMemoryQueryOutput {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl IDXCoreAdapter1 {
    pub unsafe fn GetPropertyWithInput(&self, property: DXCoreAdapterProperty, inputpropertydetailssize: usize, inputpropertydetails: Option<*const core::ffi::c_void>, outputbuffersize: usize, outputbuffer: *mut core::ffi::c_void) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetPropertyWithInput)(windows_core::Interface::as_raw(self), property, inputpropertydetailssize, core::mem::transmute(inputpropertydetails.unwrap_or(core::mem::zeroed())), outputbuffersize, core::mem::transmute(outputbuffer)).ok() }
    }
}
#[repr(C)]
