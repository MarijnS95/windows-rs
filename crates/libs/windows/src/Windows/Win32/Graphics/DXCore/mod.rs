...
pub type PFN_DXCORE_NOTIFICATION_CALLBACK = ::core::option::Option<unsafe extern "system" fn(notificationtype: DXCoreNotificationType, object: *mut ::core::ffi::c_void, context: *const ::core::ffi::c_void)>;
