...
impl Default for DOT11_AKM_CIPHER_PAIR {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for RSNA_AKM_CIPHER_PAIR {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub struct WLAN_CONNECTION_QOS_INFO {
    ...
    pub bMSCSConfigured: super::super::Foundation::BOOL,
    pub bDSCPToUPMappingConfigured: super::super::Foundation::BOOL,
    pub ulNumConfiguredSCSStreams: u32,
    pub ulNumConfiguredDSCPPolicies: u32,
}
impl Default for WLAN_CONNECTION_QOS_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub struct WLAN_QOS_CAPABILITIES {
    pub bMSCSSupported: super::super::Foundation::BOOL,
    pub bDSCPToUPMappingSupported: super::super::Foundation::BOOL,
    pub bSCSSupported: super::super::Foundation::BOOL,
    pub bDSCPPolicySupported: super::super::Foundation::BOOL,
}
impl Default for WLAN_QOS_CAPABILITIES {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub struct WLAN_QOS_INFO {
    ...
    pub bConnected: super::super::Foundation::BOOL,
    pub connectionQoSInfo: WLAN_CONNECTION_QOS_INFO,
}
impl Default for WLAN_QOS_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub struct WLAN_REALTIME_CONNECTION_QUALITY {
    ...
    pub ulRxRate: u32,
    pub ulTxRate: u32,
    pub bIsMLOConnection: super::super::Foundation::BOOL,
    pub ulNumLinks: u32,
...
impl Default for WLAN_REALTIME_CONNECTION_QUALITY_LINK_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
