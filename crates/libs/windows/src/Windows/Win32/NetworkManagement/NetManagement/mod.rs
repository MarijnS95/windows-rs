...
#[inline]
pub unsafe fn NetIsServiceAccount2<P0, P1>(servername: P0, accountname: P1, isservice: *mut super::super::Foundation::BOOL, accounttype: *mut MSA_INFO_ACCOUNT_TYPE) -> super::super::Foundation::NTSTATUS
where
    P0: windows_core::Param<windows_core::PCWSTR>,
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("netapi32.dll" "system" fn NetIsServiceAccount2(servername : windows_core::PCWSTR, accountname : windows_core::PCWSTR, isservice : *mut super::super::Foundation:: BOOL, accounttype : *mut MSA_INFO_ACCOUNT_TYPE) -> super::super::Foundation:: NTSTATUS);
    unsafe { NetIsServiceAccount2(servername.param().abi(), accountname.param().abi(), core::mem::transmute(isservice), core::mem::transmute(accounttype)) }
}
#[inline]
...
impl Default for BLOCK_NTLM_INFO {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for USE_OPTION_BLOCK_NTLM_PARAMETERS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
