...
pub unsafe fn u_stringHasBinaryProperty(s: *const u16, length: i32, which: UProperty) -> i8 {
    windows_link::link!("icu.dll" "cdecl" fn u_stringHasBinaryProperty(s : *const u16, length : i32, which : UProperty) -> i8);
...
pub unsafe fn ubrk_clone(bi: *const UBreakIterator, status: *mut UErrorCode) -> *mut UBreakIterator {
    windows_link::link!("icu.dll" "cdecl" fn ubrk_clone(bi : *const UBreakIterator, status : *mut UErrorCode) -> *mut UBreakIterator);
...
pub unsafe fn ucal_getTimeZoneOffsetFromLocal(cal: *const *const core::ffi::c_void, nonexistingtimeopt: UTimeZoneLocalOption, duplicatedtimeopt: UTimeZoneLocalOption, rawoffset: *mut i32, dstoffset: *mut i32, status: *mut UErrorCode) {
    windows_link::link!("icu.dll" "cdecl" fn ucal_getTimeZoneOffsetFromLocal(cal : *const *const core::ffi::c_void, nonexistingtimeopt : UTimeZoneLocalOption, duplicatedtimeopt : UTimeZoneLocalOption, rawoffset : *mut i32, dstoffset : *mut i32, status : *mut UErrorCode));
...
pub unsafe fn ucnv_clone(cnv: *const UConverter, status: *mut UErrorCode) -> *mut UConverter {
    windows_link::link!("icu.dll" "cdecl" fn ucnv_clone(cnv : *const UConverter, status : *mut UErrorCode) -> *mut UConverter);
...
pub unsafe fn ucol_clone(coll: *const UCollator, status: *mut UErrorCode) -> *mut UCollator {
    windows_link::link!("icu.dll" "cdecl" fn ucol_clone(coll : *const UCollator, status : *mut UErrorCode) -> *mut UCollator);
...
pub unsafe fn udatpg_getDefaultHourCycle(dtpg: *const *const core::ffi::c_void, perrorcode: *mut UErrorCode) -> UDateFormatHourCycle {
    windows_link::link!("icu.dll" "cdecl" fn udatpg_getDefaultHourCycle(dtpg : *const *const core::ffi::c_void, perrorcode : *mut UErrorCode) -> UDateFormatHourCycle);
...
pub unsafe fn udtitvfmt_formatToResult(formatter: *const UDateIntervalFormat, fromdate: f64, todate: f64, result: *mut UFormattedDateInterval, status: *mut UErrorCode) {
    windows_link::link!("icu.dll" "cdecl" fn udtitvfmt_formatToResult(formatter : *const UDateIntervalFormat, fromdate : f64, todate : f64, result : *mut UFormattedDateInterval, status : *mut UErrorCode));
...
pub unsafe fn udtitvfmt_getContext(formatter: *const UDateIntervalFormat, r#type: UDisplayContextType, status: *mut UErrorCode) -> UDisplayContext {
    windows_link::link!("icu.dll" "cdecl" fn udtitvfmt_getContext(formatter : *const UDateIntervalFormat, r#type : UDisplayContextType, status : *mut UErrorCode) -> UDisplayContext);
...
pub unsafe fn udtitvfmt_setContext(formatter: *mut UDateIntervalFormat, value: UDisplayContext, status: *mut UErrorCode) {
    windows_link::link!("icu.dll" "cdecl" fn udtitvfmt_setContext(formatter : *mut UDateIntervalFormat, value : UDisplayContext, status : *mut UErrorCode));
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("icu.dll" "cdecl" fn unumf_resultToDecimalNumber(uresult : *const UFormattedNumber, dest : windows_core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
pub unsafe fn unumrf_close(uformatter: *mut UNumberRangeFormatter) {
    windows_link::link!("icu.dll" "cdecl" fn unumrf_close(uformatter : *mut UNumberRangeFormatter));
    unsafe { unumrf_close(uformatter as _) }
}
#[inline]
pub unsafe fn unumrf_closeResult(uresult: *mut UFormattedNumberRange) {
    windows_link::link!("icu.dll" "cdecl" fn unumrf_closeResult(uresult : *mut UFormattedNumberRange));
...
where
    ...
    P3: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("icu.dll" "cdecl" fn unumrf_formatDecimalRange(uformatter : *const UNumberRangeFormatter, first : windows_core::PCSTR, firstlen : i32, second : windows_core::PCSTR, secondlen : i32, uresult : *mut UFormattedNumberRange, ec : *mut UErrorCode));
...
pub unsafe fn unumrf_formatDoubleRange(uformatter: *const UNumberRangeFormatter, first: f64, second: f64, uresult: *mut UFormattedNumberRange, ec: *mut UErrorCode) {
    windows_link::link!("icu.dll" "cdecl" fn unumrf_formatDoubleRange(uformatter : *const UNumberRangeFormatter, first : f64, second : f64, uresult : *mut UFormattedNumberRange, ec : *mut UErrorCode));
...
where
    P4: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("icu.dll" "cdecl" fn unumrf_openForSkeletonWithCollapseAndIdentityFallback(skeleton : *const u16, skeletonlen : i32, collapse : UNumberRangeCollapse, identityfallback : UNumberRangeIdentityFallback, locale : windows_core::PCSTR, perror : *mut UParseError, ec : *mut UErrorCode) -> *mut UNumberRangeFormatter);
...
pub unsafe fn unumrf_openResult(ec: *mut UErrorCode) -> *mut UFormattedNumberRange {
    windows_link::link!("icu.dll" "cdecl" fn unumrf_openResult(ec : *mut UErrorCode) -> *mut UFormattedNumberRange);
...
pub unsafe fn unumrf_resultAsValue(uresult: *const UFormattedNumberRange, ec: *mut UErrorCode) -> *mut UFormattedValue {
    windows_link::link!("icu.dll" "cdecl" fn unumrf_resultAsValue(uresult : *const UFormattedNumberRange, ec : *mut UErrorCode) -> *mut UFormattedValue);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("icu.dll" "cdecl" fn unumrf_resultGetFirstDecimalNumber(uresult : *const UFormattedNumberRange, dest : windows_core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
pub unsafe fn unumrf_resultGetIdentityResult(uresult: *const UFormattedNumberRange, ec: *mut UErrorCode) -> UNumberRangeIdentityResult {
    windows_link::link!("icu.dll" "cdecl" fn unumrf_resultGetIdentityResult(uresult : *const UFormattedNumberRange, ec : *mut UErrorCode) -> UNumberRangeIdentityResult);
...
where
    P1: windows_core::Param<windows_core::PCSTR>,
{
    windows_link::link!("icu.dll" "cdecl" fn unumrf_resultGetSecondDecimalNumber(uresult : *const UFormattedNumberRange, dest : windows_core::PCSTR, destcapacity : i32, ec : *mut UErrorCode) -> i32);
...
pub unsafe fn uset_complementAllCodePoints(set: *mut USet, str: *const u16, length: i32) {
    windows_link::link!("icu.dll" "cdecl" fn uset_complementAllCodePoints(set : *mut USet, str : *const u16, length : i32));
    unsafe { uset_complementAllCodePoints(set as _, str, length) }
}
#[inline]
pub unsafe fn uset_complementRange(set: *mut USet, start: i32, end: i32) {
    windows_link::link!("icu.dll" "cdecl" fn uset_complementRange(set : *mut USet, start : i32, end : i32));
    unsafe { uset_complementRange(set as _, start, end) }
}
#[inline]
pub unsafe fn uset_complementString(set: *mut USet, str: *const u16, length: i32) {
    windows_link::link!("icu.dll" "cdecl" fn uset_complementString(set : *mut USet, str : *const u16, length : i32));
...
pub unsafe fn uset_getRangeCount(set: *const USet) -> i32 {
    windows_link::link!("icu.dll" "cdecl" fn uset_getRangeCount(set : *const USet) -> i32);
...
pub unsafe fn uset_hasStrings(set: *const USet) -> i8 {
    windows_link::link!("icu.dll" "cdecl" fn uset_hasStrings(set : *const USet) -> i8);
...
pub unsafe fn uset_removeAllCodePoints(set: *mut USet, str: *const u16, length: i32) {
    windows_link::link!("icu.dll" "cdecl" fn uset_removeAllCodePoints(set : *mut USet, str : *const u16, length : i32));
...
pub unsafe fn uset_retainAllCodePoints(set: *mut USet, str: *const u16, length: i32) {
    windows_link::link!("icu.dll" "cdecl" fn uset_retainAllCodePoints(set : *mut USet, str : *const u16, length : i32));
    unsafe { uset_retainAllCodePoints(set as _, str, length) }
}
#[inline]
pub unsafe fn uset_retainString(set: *mut USet, str: *const u16, length: i32) {
    windows_link::link!("icu.dll" "cdecl" fn uset_retainString(set : *mut USet, str : *const u16, length : i32));
