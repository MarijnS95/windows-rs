...
pub unsafe fn BuildIoRingReadFileScatter(ioring: HIORING, fileref: IORING_HANDLE_REF, segmentarray: &[FILE_SEGMENT_ELEMENT], numberofbytestoread: u32, fileoffset: u64, userdata: usize, sqeflags: IORING_SQE_FLAGS) -> windows_core::Result<()> {
    windows_targets::link!("kernel32.dll" "system" fn BuildIoRingReadFileScatter(ioring : HIORING, fileref : IORING_HANDLE_REF, segmentcount : u32, segmentarray : *const FILE_SEGMENT_ELEMENT, numberofbytestoread : u32, fileoffset : u64, userdata : usize, sqeflags : IORING_SQE_FLAGS) -> windows_core::HRESULT);
...
pub unsafe fn BuildIoRingWriteFileGather(ioring: HIORING, fileref: IORING_HANDLE_REF, segmentarray: &[FILE_SEGMENT_ELEMENT], numberofbytestowrite: u32, fileoffset: u64, writeflags: FILE_WRITE_FLAGS, userdata: usize, sqeflags: IORING_SQE_FLAGS) -> windows_core::Result<()> {
    windows_targets::link!("kernel32.dll" "system" fn BuildIoRingWriteFileGather(ioring : HIORING, fileref : IORING_HANDLE_REF, segmentcount : u32, segmentarray : *const FILE_SEGMENT_ELEMENT, numberofbytestowrite : u32, fileoffset : u64, writeflags : FILE_WRITE_FLAGS, userdata : usize, sqeflags : IORING_SQE_FLAGS) -> windows_core::HRESULT);
...
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("bindfltapi.dll" "system" fn CreateBindLink(virtualpath : windows_core::PCWSTR, backingpath : windows_core::PCWSTR, createbindlinkflags : CREATE_BIND_LINK_FLAGS, exceptioncount : u32, exceptionpaths : *const windows_core::PCWSTR) -> windows_core::HRESULT);
...
#[inline]
pub unsafe fn GetFileInformationByName<P0>(filename: P0, fileinformationclass: FILE_INFO_BY_NAME_CLASS, fileinfobuffer: *mut core::ffi::c_void, fileinfobuffersize: u32) -> super::super::Foundation::BOOL
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("kernel32.dll" "system" fn GetFileInformationByName(filename : windows_core::PCWSTR, fileinformationclass : FILE_INFO_BY_NAME_CLASS, fileinfobuffer : *mut core::ffi::c_void, fileinfobuffersize : u32) -> super::super::Foundation:: BOOL);
    unsafe { GetFileInformationByName(filename.param().abi(), fileinformationclass, core::mem::transmute(fileinfobuffer), fileinfobuffersize) }
}
#[inline]
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("bindfltapi.dll" "system" fn RemoveBindLink(virtualpath : windows_core::PCWSTR) -> windows_core::HRESULT);
