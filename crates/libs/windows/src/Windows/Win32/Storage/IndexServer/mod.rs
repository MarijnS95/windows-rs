...
impl IPixelFilter {
    ...
    pub unsafe fn GetPixelsForImage(&self, pixelbufferlength: *mut u32, pixelbuffer: *mut *mut u8) -> windows_core::Result<()> {
        unsafe { (windows_core::Interface::vtable(self).GetPixelsForImage)(windows_core::Interface::as_raw(self), core::mem::transmute(pixelbufferlength), core::mem::transmute(pixelbuffer)).ok() }
    }
}
#[repr(C)]
