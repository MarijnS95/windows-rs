...
pub unsafe fn WinHttpProtocolCompleteUpgrade(hrequest: *const core::ffi::c_void, dwcontext: Option<usize>) -> *mut core::ffi::c_void {
    ...
    unsafe { WinHttpProtocolCompleteUpgrade(hrequest, core::mem::transmute(dwcontext.unwrap_or(core::mem::zeroed()))) }
}
#[inline]
pub unsafe fn WinHttpProtocolReceive(protocolhandle: *const core::ffi::c_void, flags: u64, pvbuffer: *mut core::ffi::c_void, dwbufferlength: u32, pdwbytesread: *mut u32) -> u32 {
    ...
    unsafe { WinHttpProtocolReceive(protocolhandle, flags, core::mem::transmute(pvbuffer), dwbufferlength, core::mem::transmute(pdwbytesread)) }
}
#[inline]
...
#[cfg(target_arch = "x86")]
impl Default for WINHTTP_FAST_FORWARDING_STATUS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for WINHTTP_PROTOCOL_ASYNC_RESULT {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
