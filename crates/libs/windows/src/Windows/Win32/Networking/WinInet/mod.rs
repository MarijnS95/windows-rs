...
impl IProofOfPossessionCookieInfoManager3 {
    ...
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoForUriWithOptions)(windows_core::Interface::as_raw(self), uri.param().abi(), options, core::mem::transmute(cookieinfocount), core::mem::transmute(cookieinfo)).ok() }
    }
}
#[repr(C)]
...
impl IProofOfPossessionCookieInfoManager4 {
    ...
    where
        ...
        P1: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoForUriWithUserAgentId)(windows_core::Interface::as_raw(self), uri.param().abi(), uaclientid.param().abi(), core::mem::transmute(cookieinfocount), core::mem::transmute(cookieinfo)).ok() }
    }
    ...
    where
        ...
        P2: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe { (windows_core::Interface::vtable(self).GetCookieInfoWithUriAndUserAgentIdForAccount)(windows_core::Interface::as_raw(self), webaccount.param().abi(), uri.param().abi(), uaclientid.param().abi(), core::mem::transmute(cookieinfocount), core::mem::transmute(cookieinfo)).ok() }
    }
}
#[repr(C)]
