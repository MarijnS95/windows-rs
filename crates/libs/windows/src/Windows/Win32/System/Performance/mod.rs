...
where
    ...
    P2: windows_core::Param<windows_core::PCSTR>,
{
    windows_targets::link!("loadperf.dll" "system" fn UpdatePerfNameFilesA(sznewctrfilepath : windows_core::PCSTR, sznewhlpfilepath : windows_core::PCSTR, szlanguageid : windows_core::PCSTR, dwmodes : usize) -> u32);
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("loadperf.dll" "system" fn UpdatePerfNameFilesW(sznewctrfilepath : windows_core::PCWSTR, sznewhlpfilepath : windows_core::PCWSTR, szlanguageid : windows_core::PCWSTR, dwmodes : usize) -> u32);
