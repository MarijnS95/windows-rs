...
pub unsafe fn PowerGetUserConfiguredACPowerMode(powermodeguid: *mut windows_core::GUID) -> u32 {
    windows_targets::link!("powrprof.dll" "system" fn PowerGetUserConfiguredACPowerMode(powermodeguid : *mut windows_core::GUID) -> u32);
    unsafe { PowerGetUserConfiguredACPowerMode(core::mem::transmute(powermodeguid)) }
}
#[inline]
pub unsafe fn PowerGetUserConfiguredDCPowerMode(powermodeguid: *mut windows_core::GUID) -> u32 {
    windows_targets::link!("powrprof.dll" "system" fn PowerGetUserConfiguredDCPowerMode(powermodeguid : *mut windows_core::GUID) -> u32);
    unsafe { PowerGetUserConfiguredDCPowerMode(core::mem::transmute(powermodeguid)) }
}
#[cfg(feature = "Win32_System_Registry")]
#[inline]
...
pub unsafe fn PowerSetUserConfiguredACPowerMode(powermodeguid: *const windows_core::GUID) -> u32 {
    windows_targets::link!("powrprof.dll" "system" fn PowerSetUserConfiguredACPowerMode(powermodeguid : *const windows_core::GUID) -> u32);
...
pub unsafe fn PowerSetUserConfiguredDCPowerMode(powermodeguid: *const windows_core::GUID) -> u32 {
    windows_targets::link!("powrprof.dll" "system" fn PowerSetUserConfiguredDCPowerMode(powermodeguid : *const windows_core::GUID) -> u32);
