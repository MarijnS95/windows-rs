...
where
    P4: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("wldp.dll" "system" fn WldpCanExecuteFileFromDetachedSignature(host : *const windows_core::GUID, options : WLDP_EXECUTION_EVALUATION_OPTIONS, contentfilehandle : super::super::Foundation:: HANDLE, signaturefilehandle : super::super::Foundation:: HANDLE, auditinfo : windows_core::PCWSTR, result : *mut WLDP_EXECUTION_POLICY) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        WldpCanExecuteFileFromDetachedSignature(host, options, contentfilehandle, signaturefilehandle, auditinfo.param().abi(), &mut result__).map(|| core::mem::transmute(result__))
    }
}
...
pub unsafe fn WldpQuerySecurityPolicy(providername: *const super::super::Foundation::UNICODE_STRING, keyname: *const super::super::Foundation::UNICODE_STRING, valuename: *const super::super::Foundation::UNICODE_STRING, valuetype: *mut WLDP_SECURE_SETTING_VALUE_TYPE, valueaddress: Option<*mut core::ffi::c_void>, valuesize: *mut u32) -> windows_core::Result<()> {
    ...
    unsafe { WldpQuerySecurityPolicy(providername, keyname, valuename, core::mem::transmute(valuetype), core::mem::transmute(valueaddress.unwrap_or(core::mem::zeroed())), core::mem::transmute(valuesize)).ok() }
}
#[inline]
...
impl Default for PROCESS_CREATION_SVE_VECTOR_LENGTH_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub type PWLDP_GETAPPLICATIONSETTINGBOOLEAN_API = Option<unsafe extern "system" fn(id: windows_core::PCWSTR, setting: windows_core::PCWSTR, result: *mut super::super::Foundation::BOOL) -> windows_core::HRESULT>;
