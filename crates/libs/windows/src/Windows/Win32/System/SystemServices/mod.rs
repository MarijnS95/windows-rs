...
impl Default for ATTRIBUTES_AND_SID {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
pub struct FILE_STAT_BASIC_INFORMATION {
    ...
    pub FileId128: super::super::Storage::FileSystem::FILE_ID_128,
}
#[cfg(feature = "Win32_Storage_FileSystem")]
...
impl Default for IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_XDATA_EPILOG_SCOPE_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY_XDATA_EXTENDED_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for IMAGE_HOT_PATCH_MACHINE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for IMAGE_HOT_PATCH_MACHINE_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for IMAGE_IMPORT_CONTROL_TRANSFER_ARM64_RELOCATION {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for JOBOBJECT_NETWORK_ACCOUNTING_INFORMATION {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for POWER_LIMIT_ATTRIBUTES_0_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for POWER_LIMIT_VALUE {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for PROCESS_NETWORK_COUNTERS {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
