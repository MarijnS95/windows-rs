...
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computestorage.dll" "system" fn HcsAttachOverlayFilter(volumemountpoint : windows_core::PCWSTR, layerdata : windows_core::PCWSTR) -> windows_core::HRESULT);
...
where
    ...
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computestorage.dll" "system" fn HcsDetachOverlayFilter(volumemountpoint : windows_core::PCWSTR, layerdata : windows_core::PCWSTR) -> windows_core::HRESULT);
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computecore.dll" "system" fn HcsFinalizeLiveMigration(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_core::PCWSTR) -> windows_core::HRESULT);
...
where
    P1: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computecore.dll" "system" fn HcsGetOperationProperties(operation : HCS_OPERATION, options : windows_core::PCWSTR, resultdocument : *mut windows_core::PWSTR) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        HcsGetOperationProperties(operation, options.param().abi(), &mut result__).map(|| core::mem::transmute(result__))
    }
}
#[inline]
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computecore.dll" "system" fn HcsInitializeLiveMigrationOnSource(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_core::PCWSTR) -> windows_core::HRESULT);
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computecore.dll" "system" fn HcsStartLiveMigrationOnSource(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_core::PCWSTR) -> windows_core::HRESULT);
...
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_targets::link!("computecore.dll" "system" fn HcsStartLiveMigrationTransfer(computesystem : HCS_SYSTEM, operation : HCS_OPERATION, options : windows_core::PCWSTR) -> windows_core::HRESULT);
