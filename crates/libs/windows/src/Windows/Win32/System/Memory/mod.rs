...
#[inline]
pub unsafe fn GetMemoryNumaClosestInitiatorNode(targetnodenumber: u32, initiatornodenumber: *mut u32) -> super::super::Foundation::BOOL {
    windows_targets::link!("api-ms-win-core-memory-l1-1-9.dll" "system" fn GetMemoryNumaClosestInitiatorNode(targetnodenumber : u32, initiatornodenumber : *mut u32) -> super::super::Foundation:: BOOL);
    unsafe { GetMemoryNumaClosestInitiatorNode(targetnodenumber, core::mem::transmute(initiatornodenumber)) }
}
#[inline]
pub unsafe fn GetMemoryNumaPerformanceInformation(nodenumber: u32, datatype: u8, perfinfo: *mut *mut WIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT) -> super::super::Foundation::BOOL {
    windows_targets::link!("api-ms-win-core-memory-l1-1-9.dll" "system" fn GetMemoryNumaPerformanceInformation(nodenumber : u32, datatype : u8, perfinfo : *mut *mut WIN32_MEMORY_NUMA_PERFORMANCE_INFORMATION_OUTPUT) -> super::super::Foundation:: BOOL);
    unsafe { GetMemoryNumaPerformanceInformation(nodenumber, datatype, core::mem::transmute(perfinfo)) }
}
#[inline]
...
impl Default for WIN32_MEMORY_NUMA_PERFORMANCE_ENTRY {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for WIN32_MEMORY_NUMA_PERFORMANCE_ENTRY_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
