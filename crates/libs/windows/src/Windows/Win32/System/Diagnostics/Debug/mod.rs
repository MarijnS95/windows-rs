...
#[inline]
pub unsafe fn SymGetParentWindow(phwnd: *mut super::super::super::Foundation::HWND) -> super::super::super::Foundation::BOOL {
    windows_targets::link!("dbghelp.dll" "system" fn SymGetParentWindow(phwnd : *mut super::super::super::Foundation:: HWND) -> super::super::super::Foundation:: BOOL);
    unsafe { SymGetParentWindow(core::mem::transmute(phwnd)) }
}
#[inline]
...
impl Default for DIMM_ADDRESS_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DIMM_ADDRESS_1 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DIMM_ADDR_VALID_BITS_DDR4 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for DIMM_ADDR_VALID_BITS_DDR5 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for MINIDUMP_SYSTEM_MEMORY_INFO_2 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for MINIDUMP_SYSTEM_PERFORMANCE_INFORMATION_2 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for PAGE_OFFLINE_VALID_BITS_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
