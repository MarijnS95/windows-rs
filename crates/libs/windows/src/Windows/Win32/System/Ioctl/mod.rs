...
impl Default for DEVICE_DSM_QUERY_PREFER_LOCAL_REPAIR_OUTPUT {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for STORAGE_CRYPTO_CAPABILITY_V2_0_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for STORAGE_CRYPTO_DESCRIPTOR_V2_0_0 {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
...
impl Default for STORAGE_STACK_DESCRIPTOR {
    fn default() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
