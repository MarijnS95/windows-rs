    ...
    pub unsafe fn GetThreadGroupSize(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetThreadGroupSize)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(psizex.unwrap_or(core::mem::zeroed())),
                core::mem::transmute(psizey.unwrap_or(core::mem::zeroed())),
                core::mem::transmute(psizez.unwrap_or(core::mem::zeroed())),
            )
        }
    }
...
pub struct ID3D12ShaderReflection_Vtbl {
    ...
    pub IsSampleFrequencyShader: unsafe extern "system" fn(*mut core::ffi::c_void) -> BOOL,
    ...
    pub unsafe fn GetEncoding(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetEncoding)(
                windows_core::Interface::as_raw(self),
                core::mem::transmute(pknown),
                core::mem::transmute(pcodepage),
            )
            .ok()
        }
    }
...
pub trait IDxcBlobEncoding_Impl: IDxcBlob_Impl {
    fn GetEncoding(&self, pknown: *mut BOOL, pcodepage: *mut DXC_CP) -> windows_core::Result<()>;
}
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).CreateBlobFromFile)(
                windows_core::Interface::as_raw(self),
                pfilename.param().abi(),
                core::mem::transmute(codepage.unwrap_or(core::mem::zeroed())),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
...
pub struct IDxcResult_Vtbl {
    ...
    pub HasOutput: unsafe extern "system" fn(*mut core::ffi::c_void, DXC_OUT_KIND) -> BOOL,
        ...
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
            ...
            (windows_core::Interface::vtable(self).LoadFile)(
                windows_core::Interface::as_raw(self),
                pfilename.param().abi(),
                core::mem::transmute(pcodepage.unwrap_or(core::mem::zeroed())),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
        }
    ...
    pub unsafe fn GetDxilContainerPart(
        ...
        unsafe {
            (windows_core::Interface::vtable(self).GetDxilContainerPart)(
                ...
                pshader,
                dxcpart,
                core::mem::transmute(pppartdata),
                core::mem::transmute(ppartsizeinbytes),
            )
            .ok()
        }
    }
